...
def save_results(claim_id, status_code, cycle_length, data_url, data_filename):
    """
...
def main():
    ...
    try:
        ...
        # Download the file or use existing
        LOGGER.info("")
        ...
        if claim_id is not None:
            ...
            save_results(claim_id, status_code, cycle_length, args.data_url, filename)
